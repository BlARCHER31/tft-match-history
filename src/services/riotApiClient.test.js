...
describe('When fetching summoner info using summonerName, the Riot APi Client',() => {
    ...
    test('The transform summoner info function reduces an object and returns a new one.', async () => {
        ...
        const expectedResult = {summonerName: mockedResponse.data.name,
        ...
        const result = await riotApiClient.fetchTFTSummonerInfo(mockedResponse.data.name)
    ...
    test('RiotApiClient throws an error', async () => {
        ...
        await expect(riotApiClient.fetchTFTSummonerInfo(summonerName)).rejects.toThrow()
...
describe('When fetching summoner info using puuid, the Riot APi Client', () => {
    ...
    test('The transform summoner info function reduces an object and returns a new one.', async () => {
        ...
        const result = await riotApiClient.fetchTFTSummonerInfoByPuuid(mockedResponse.data.name)
        expect(result).toEqual(expectedResult)
    ...
    test('RiotApiClient throws an error', async () => {
        ...
        await expect(riotApiClient.fetchTFTSummonerInfoByPuuid(puuid)).rejects.toThrow()
...
describe(`Getting a specific number of match Id's, The riot api client`, () => {
    ...
    test('RiotApiClient throws an error', async () => {
        ...
        await expect(riotApiClient.getRecentMatchesList(puuid, count)).rejects.toThrow()
